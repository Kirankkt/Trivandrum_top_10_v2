...
-- 5. Create a generic events table (Industry Standard Tracking)
...
-- 6. Enable Security for site_events
alter table site_events enable row level security;

create policy "Enable insert for all users" on site_events for insert with check (true);
